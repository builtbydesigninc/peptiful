...
const payouts = [
  { id: 'APAY-012', date: 'Feb 15, 2026', amount: '$988', method: 'PayPal', status: 'completed' },
  { id: 'APAY-011', date: 'Jan 15, 2026', amount: '$742', method: 'PayPal', status: 'completed' },
  { id: 'APAY-010', date: 'Dec 15, 2025', amount: '$565', method: 'PayPal', status: 'completed' },
];
      ...
      <div className='grid grid-cols-1 gap-4 sm:grid-cols-3'>
        <div className='rounded-xl border border-stroke-soft-200 bg-bg-white-0 p-5 shadow-regular-xs'>
          <div className='flex items-center gap-3'>
            ...
            <div><p className='text-label-xs text-text-sub-600'>Next Payout</p><p className='text-title-h5 text-text-strong-950'>$1,262</p></div>
          </div>
        ...
        <div className='rounded-xl border border-stroke-soft-200 bg-bg-white-0 p-5 shadow-regular-xs'>
          <div className='flex items-center gap-3'>
            ...
            <div><p className='text-label-xs text-text-sub-600'>Total Received</p><p className='text-title-h5 text-text-strong-950'>$2,295</p></div>
          </div>
          <div className='mt-4 rounded-10 bg-bg-weak-50 px-3 py-2 flex justify-between'>
            <span className='text-paragraph-xs text-text-sub-600'>Payouts</span>
            <span className='text-label-xs text-text-strong-950'>3 completed</span>
          </div>
        </div>
        <div className='rounded-xl border border-stroke-soft-200 bg-bg-white-0 p-5 shadow-regular-xs'>
          <div className='flex items-center justify-between'>
            <div className='flex items-center gap-3'>
              ...
              <div><p className='text-label-xs text-text-sub-600'>Payment Method</p><p className='text-label-md text-text-strong-950'>PayPal</p></div>
            </div>
          ...
          <div className='mt-4 rounded-10 bg-bg-weak-50 px-3 py-2 flex justify-between'>
            ...
            <span className='text-label-xs text-text-strong-950'>jessica@fitness.com</span>
          </div>
        </div>
      </div>
      <div className='rounded-xl border border-stroke-soft-200 bg-bg-white-0 shadow-regular-xs overflow-hidden'>
        <div className='border-b border-stroke-soft-200 px-5 py-4'><h3 className='text-label-md text-text-strong-950'>Payout History</h3></div>
